...
[![](https://img.shields.io/github/v/release/okaya0x/3x-ui.svg)](https://github.com/okaya0x/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/okaya0x/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/okaya0x/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/okaya0x/3x-ui/total.svg)](#)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/okaya0x/3x-ui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/okaya0x/3x-ui/master/install.sh) v2.4.4
```
...
wget https://github.com/okaya0x/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. **Clone the Project Repository:**
   ...
   ```sh
   git clone https://github.com/okaya0x/3x-ui.git
   cd 3x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/okaya0x/3x-ui.svg)](https://starchart.cc/okaya0x/3x-ui)
